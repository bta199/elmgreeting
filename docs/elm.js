...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aF, request.ap, true);
		} catch (e) {
...
var $author$project$Main$GotRandomName = function (a) {
	return {$: 2, a: a};
};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{av: false, ax: r.ax, S: r.S, U: r.U, aF: r.aF, aP: r.aP, ao: r.ao, ap: r.ap}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{ax: $elm$http$Http$emptyBody, S: r.S, U: _List_Nil, aF: 'GET', aP: $elm$core$Maybe$Nothing, ao: $elm$core$Maybe$Nothing, ap: r.ap});
};
var $author$project$Main$getHeading = function (value) {
	return 'Hello ' + value;
};
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$index = _Json_decodeIndex;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$nameDecoder = A2(
	...
	A2(
		...
		A2(
			$elm$json$Json$Decode$field,
			'name',
			A2($elm$json$Json$Decode$field, 'first', $elm$json$Json$Decode$string))));
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{
			s: $author$project$Main$getHeading('...'),
			t: '',
			w: ''
		},
		$elm$http$Http$get(
			{
				S: A2($elm$http$Http$expectJson, $author$project$Main$GotRandomName, $author$project$Main$nameDecoder),
				ap: 'https://randomuser.me/api/'
			}));
};
...
var $author$project$Main$getModelWithRandomName = _Utils_Tuple2(
	{
		s: $author$project$Main$getHeading('...'),
		t: '',
		w: ''
...
var $author$project$Main$getQuestion = 'Is that really your name?';
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 1:
				return $author$project$Main$getModelWithRandomName;
			default:
				var result = msg.a;
				if (result.$ === 1) {
					return _Utils_Tuple2(
						{
							s: $author$project$Main$getHeading('Umm... 😅'),
							t: '',
							w: 'I am having trouble coming up with a name!'
						},
						$elm$core$Platform$Cmd$none);
				} else {
					var text = result.a;
					return _Utils_Tuple2(
						{
							s: $author$project$Main$getHeading(text) + '!',
							t: '',
							w: $author$project$Main$getQuestion
						},
						$elm$core$Platform$Cmd$none);
...
var $author$project$Main$GetRandomName = {$: 1};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('greeting')
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Main$GetRandomName)
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Guess Again')
									]))
							]))
					]))
			]),
		aQ: 'Greetings - Elm Demo'
	};
};
var $author$project$Main$main = $elm$browser$Browser$document(
	{aE: $author$project$Main$init, aO: $author$project$Main$subscriptions, aR: $author$project$Main$update, aS: $author$project$Main$view});
